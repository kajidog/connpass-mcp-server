...
export const FORMAT_PRESETS = {
  default: { descriptionLimit: 0, catchPhraseLimit: undefined } as FormatEventOptions,
  detailed: { descriptionLimit: 200, catchPhraseLimit: undefined } as FormatEventOptions,
  full: { descriptionLimit: undefined, catchPhraseLimit: undefined } as FormatEventOptions,
}
