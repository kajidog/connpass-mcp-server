...
- 378aed3: Improve connpass API v2 compatibility and user resolution across the client and MCP server.
...
- Updated dependencies [378aed3]
  - @kajidog/connpass-api-client@0.5.0
